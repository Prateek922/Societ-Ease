  ...
  return (
    <>
      <div className="content w-auto h-auto">
        <Row>
        <Col lg="2" md="4" sm="12" className="mx-4 d-flex align-items-center" ><FontAwesomeIcon icon={faCirclePlus} style={{width:"auto",height:"50%",color: "#7a7a7a",}} onClick={()=>{editRef.current.click(); console.log("hello")}}/></Col>
          <Col lg="4" md="4" sm="12">
